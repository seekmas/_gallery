...
class FieldsControllerTest < ActionController::TestCase
  ...
  test "should create field" do
    assert_difference('Field.count') do
      post :create, field: { activity_id: @field.activity_id, key_name: @field.key_name, value_name: @field.value_name }
    end
  ...
  test "should update field" do
    patch :update, id: @field, field: { activity_id: @field.activity_id, key_name: @field.key_name, value_name: @field.value_name }
    assert_redirected_to field_path(assigns(:field))
  end
